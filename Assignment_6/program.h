...
*/
    ...
    void enqueue(int lineNUmber, Cell *cell);
...
private:
    ...
    //Linked-list (stores program sequence):
    Cell *head;
    Cell *tail;
    int count;

    //Statement container (bug fix):
    ...
    //Stores the program statements:
    HashMap<int, StatementContainer> *statementMap;
